          ...
          <div class="col-4 col-sm-3 col-md-3 col-lg-2">
            <div class="site-cart">
              <a href="#" class="site-header__cart" title="Cart">
                ...
                <span id="CartCount" class="site-header__cart-count" data-cart-render="item_count">{{ count(Cart::content()) }}</span>
              </a>
              <!--Minicart Popup-->
                    ...
                    @forelse($carts as $cart)
                        <li class="item">
                            <a class="product-image" href="#">
                              <img src="{{asset('uploads/product/'.$cart->options->image)}}" alt="3/4 Woman Dress 7" title="" />
                            </a>
                            <div class="product-details">
                              <a href="{{route('cartdelete',[$cart->rowId])}}" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
{{--                              <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>--}}
                              <a class="pName" href="">{{ $cart->name }}</a>
                              <div class="variant-cart">Black / XL</div>
                              <div class="wrapQtyBtn">
                                <div class="qtyField">
                                  <span class="label">Qty: {{ $cart->qty }}</span>
...
{{--                                  <a class="qtyBtn plus" href="javascript:void(0);"><i class="fa anm anm-plus-r" aria-hidden="true"></i></a>--}}
                              ...
                              <div class="priceRow">
                                <div class="product-price">
                                  <span class="money">৳{{ $cart->subtotal }}</span>
                                </div>
                              </div>
                            </div>
                        </li>
                    @empty
                        <li class="item text-center">Empty Cart.</li>
                    @endforelse
{{--                  <li class="item">--}}
{{--                    <a class="product-image" href="#">--}}
...
{{--                  </li>--}}
                ...
                <div class="total">
                  ...
                  <div class="buttonSet text-center">
                    ...
                    <a href="{{route('checkout_view')}}" class="btn btn-secondary btn--small">Checkout</a>
                  </div>
                </div>
              </div>
              <!--End Minicart Popup-->
