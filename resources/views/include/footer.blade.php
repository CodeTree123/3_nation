                  ...
                  <div class="row justify-content-between">
                      ...
                      <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                          ...
                          <ul class="addressFooter">
                              <li><i class="icon anm anm-map-marker-al"></i><p>3 Nation BD Address</p></li>
                              <li class="phone"><i class="icon anm anm-phone-s"></i><p> 000 000 0000</p></li>
                              <li class="email"><i class="icon anm anm-envelope-l"></i><p>3nation@email.com</p></li>
                          </ul>
                      </div>
                  </div>
              </div>
              ...
              <div class="footer-bottom">
                  <div class="row">
                      ...
                      <div class="col-12 col-sm-12 col-md-12 col-lg-12 order-1 order-md-0 order-lg-0 order-sm-1 copyright text-center">
                        Developed By <a href="https://codetreebd.com/"> CODETREE</a></div>
